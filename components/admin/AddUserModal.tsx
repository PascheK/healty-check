...
export default function AddUserModal({ onCreate, isOpen, isClosing, onClose }: Props) {
  ...
  return (
        ...
        <input
          ...
          className="w-full mb-3 px-3 py-2 bg-background border text-text-primary border-border rounded transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
        <input
          type="text"
          placeholder="Code"
